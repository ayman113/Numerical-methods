...
% >> RK(fdy,xi,xo,Y,h,type)
function RK1(fdy,xi,xo,Y,h,type)
% if isempty(fy)
%     fDY=sym(fdy);
%     fy=int(fDY);
...
%             Yt(i+1)=FY(i+1);
        ...
        i=0:i-1;
        t=[i'  X'  K1'  K2'  Y'  ];
        fprintf('i           X               K1                K2             Y Rk-2 Ralston       \n');
        fprintf('%i   %13.5f    %13.5f     %13.5f    %13.5f     \n',t');
    case '3'
        while true
            K1(i)=fdy(X(i),Y(i));
...
%             Yt(i+1)=FY(i+1);
        ...
        i=0:i-1;
        t=[i'  X'  K1'  K2' K3'  Y'  ];
        fprintf('i           X               K1                 K2                 K3             Y Rk-3            \n');
        fprintf('%i   %13.5f    %13.5f     %13.5f     %13.5f    %13.5f     \n',t');
    case '4'
        while true
            K1(i)=fdy(X(i),Y(i));
            K2(i)=fdy(X(i)+0.5*h,Y(i)+0.5*K1(i)*h);
...
%             Yt(i+1)=FY(i+1);
        ...
        i=0:i-1;
        t=[i'  X'  K1'  K2' K3'  K4'  Y'  ];
        fprintf('i           X                K1                K2                K3                K4             Y Rk-4            \n');
